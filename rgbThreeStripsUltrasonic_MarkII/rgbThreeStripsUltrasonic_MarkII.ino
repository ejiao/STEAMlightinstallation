...
static int FAR = 0,
           ...
           STRIP_THREE = 3,
           R = 0, G = 1, B = 2,
           MAX_BRIGHTNESS = 50, // reduced from 255
           MED_BRIGHTNESS = 20,
           IDLE_BRIGHTNESS = 10,
           FRAME_RATE = 30; //smaller is faster 
...
void updateStripStates(int d1, int d2, int d3) {
  updateParticularStrip(d1, R, strip1, 1);
  updateParticularStrip(d2, R, strip2, 1);
  updateParticularStrip(d3, R, strip3, 1);
}
